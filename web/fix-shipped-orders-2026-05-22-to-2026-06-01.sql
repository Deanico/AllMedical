-- One-time repair for shipped orders that were scheduled with legacy 88-day logic.
...
--
-- Target window (inclusive): 2026-05-22 to 2026-06-01
--
-- Safety rules:
...
WITH params AS (
  SELECT DATE '2026-05-22' AS start_date, DATE '2026-06-01' AS end_date
), shipped_in_range AS (
  SELECT
