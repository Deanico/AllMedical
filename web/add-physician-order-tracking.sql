...
ADD COLUMN IF NOT EXISTS physician_order_sent_to_insurance_at TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS physician_order_insurance_received_at TIMESTAMP WITH TIME ZONE,
...
COMMENT ON COLUMN leads.physician_order_sent_to_insurance_at IS 'When the physician order was sent to insurance';
COMMENT ON COLUMN leads.physician_order_insurance_received_at IS 'When insurance confirmed receipt of the physician order';
