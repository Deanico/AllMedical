-- Update pump supplies with specific product variations
-- Run this to replace the generic "Insulin Pump Tubing" with specific products

-- Remove the generic tubing entry
DELETE FROM products WHERE name = 'Insulin Pump Tubing';

-- Add specific infusion sets and pump supplies
...
-- Show all infusion sets
SELECT name, manufacturer, description
FROM products
WHERE category = 'infusion_set'
